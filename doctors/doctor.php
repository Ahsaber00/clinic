        ...
        <div class="container">
            ...
            <div class="d-flex flex-column gap-3 details-card doctor-details">
                <div class="details d-flex gap-2 align-items-center">
                    <img src="../design/uploaded_image/<?=$doctorData['image']?>" alt="doctor" class="img-fluid rounded-circle" height="150"
                        width="150">
                    <div class="details-info d-flex flex-column gap-3 ">
                        <h4 class="card-title fw-bold"><?php echo $doctorData['name'] ?></h4>
                        ...
                        <h6 class="card-title fw-bold">
                            <?php
                            $majorData=$major->getMajorById($doctorData['major_id']);
                            echo "Doctor Major: ";
                            echo strtoupper($majorData['name']);
                            echo"<br>";
                            echo"Doctor Bio: ";
                            echo $doctorData['bio'];
                            ?>
                ...
                ?>
                    ...
                    ?>
                <form class="form" action="../core/handelers/handelAddBooking.php" method="post" >
