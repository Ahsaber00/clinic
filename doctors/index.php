        ...
        <div class="container">
            ...
            <?php foreach($doctorsList as $doctor): ?>
                <div class="card p-2" style="width: 18rem;">
                    <img src="../design/uploaded_image/<?=$doctor['image']?>" class="card-img-top rounded-circle card-image-circle" alt="major">
                    <div class="card-body d-flex flex-column gap-1 justify-content-center">
                        <h4 class="card-title fw-bold text-center"><?php echo $doctor['name'] ?></h4>
                        <h6 class="card-title fw-bold text-center"><?php $doctorMajor= $major->getMajorById($doctor['major_id']);
                        echo $doctorMajor['name']; ?></h6>
                        <a href="./doctor.php?id=<?=$doctor['id']?>" doctor.php" class="btn btn-outline-primary card-button">Book anappointment</a>
                    </div>
                </div>
            <?php endforeach; ?>
            </div>
        ...
        <div class="row gap-2">
            ...
            <div class="col-sm order-sm-2">
                ...
                <div class="links d-flex gap-2 flex-wrap">
                    <a href="../index.php" index.php" class="link text-white">Home</a>
                    <a href="../majors.php" majors.php" class="link text-white">Majors</a>
                    <a href="./index.php" doctors/index.php" class="link text-white">Doctors</a>
                    <a href="../login.php" login.php" class="link text-white">Login</a>
                    <a href="../register.php" register.php" class="link text-white">Register</a>
                    <a href="../contact.php" contact.php" class="link text-white">Contact</a>
                </div>
            </div>
        </div>
    </footer>
