      ...
      <div class="card">
        ...
        <?php
            ...
            ?>
                  ...
                  ?>
        <form method="POST" action="../core/handelers/handelAddMajor.php" enctype="multipart/form-data" >
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Major Name</label>
                    <input type="text" name="name" class="form-control" id="exampleInputEmail1" placeholder="Enter Major Name">
                  </div>
